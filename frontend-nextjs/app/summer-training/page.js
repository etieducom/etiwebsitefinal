...
export const metadata = {
  title: 'Summer Training 2025 | 6 Weeks & 6 Months IT Programs',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-lg text-blue-100 mb-8 max-w-lg">
                Boost your career with industry-relevant skills this summer. Get hands-on 
                training in trending technologies from expert faculty.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Why Choose ETI Educom Summer Training?
              </h2>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    Perfect for college students during summer break.
                  </p>
                </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-primary-dark">
        <div className="container-main text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Summer batches fill up fast. Register now to secure your spot and 
            kickstart your IT career this summer.
          </p>
